...
if($aksi=='create'){
  ...
  mysqli_query($koneksi, "INSERT INTO pegawai SET idpegawai='$idpegawai', nama='$nama', username='$username',password='$password', alamat='$alamat', nohp='$nohp'");
}
elseif($aksi=="edit"){
  ...
  $query="UPDATE pegawai SET nama='$nama',username='$username',password='$password', 
